...
'''
  Usage:
    PROG [ -f ] [ ( -y OLD | --yaml OLD ) ] NEW
    PROG (-h | --help | -v | --version)

  Options:
    -f, --force      Overwrite output file
    -h, --help       Show this screen and exit.
    -v, --version    Show version and exit.
    -y, --yaml OLD   Fork this yaml file
'''
...
from util import load_history_from_txt, start_history_to_yml
...
class Convo:
    ...
    def load_history_full(_, ident):
        
        pass
    
    def load_history_part(_, ident):
        load_history_from_yml(ident+'.yml')
...
if __name__=='__main__':
    ...
    if OLD:
        print("LOAD OLD", OLD)
        fmessages = list( load_history_from_yml( OLD+'.yml' ) )
        pass
    else:       
    ...
    try:
        ...
        if args['--force']:
            ...
            print("DONT FORCE IT< BACK OFF")
            raise
        pass    

    print("WRITE/OVERWRITE NEW FILE")
    fork_history_to_yml(NEW+'.yml',
                        name=NEW,
                        forked_from=OLD)
