...
class Convo:
    ...
    def once(_):
        ...
        if method=='initialize':
            ...
            print("PUBBBBB", params)
            if params.get('kind') == 'session':
                _.got_pubx(**params)
            else:
    ...
    def load_session(_, user_id, session_id):
        print("LOAD THAT SESSION!!!!!!", fmessages)
        print("LOAD THAT SESSION!!!!!!", _.messages)
        #_.history = []
        if fmessages:
            print("F", fmessages[0])
            d = dict(role='system',
    ...
    def main(_, _user_id=None,
        ...
        print("SSSSSS", (user_id, session_id))
