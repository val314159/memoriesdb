...
CREATE INDEX idx_audit_log_record ON audit_log(table_name, record_id, operation_timestamp DESC);
CREATE INDEX idx_audit_log_time ON audit_log(operation_timestamp DESC);
...
CREATE INDEX idx_memory_edges_relation_strength_confidence ON memory_edges(relation, strength, confidence);
